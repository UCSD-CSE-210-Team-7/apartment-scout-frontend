            ...
            { scout.calendly_link ? 
              <Grid item>
                ...
                >
                  ...
                  <Grid item>
                    <TextField id="outlined-basic" required label="Tour Address" variant="outlined" 
                        value={tourAddress}
                  ...
                  <Grid item className="calendly-widget">
                    <InlineWidget styles={{height: '900px'}} url={scout.calendly_link} /> 
                  </Grid>
                </Grid>
              </Grid> :
                <h1>We're sorry, but this user does not <br/> support automated tour booking. Try chat!</h1>
            }
        </Grid>
      </Grid>
      )}
