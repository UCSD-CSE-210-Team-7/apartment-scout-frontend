...
function RequesterSubmitReview() {
  ...
  const [createReviewForScoutMutation] = useMutation(
    CREATE_REVIEW_FOR_SCOUT_MUTATION
  );
    ...
    <div>
      <div className="header">
        ...
        <div className="rating-input">
          <label htmlFor="rating-input-field" className="text-rating">
            {" "}
            Rating (5 for very good, 1 for very bad):{" "}
          </label>
          <Rating
